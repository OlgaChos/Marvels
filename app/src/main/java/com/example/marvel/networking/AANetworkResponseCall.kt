...
internal class AANetworkResponseCall<S : Any, E : Any>(
    ...
    override fun enqueue(callback: Callback<NetworkResponse<S, E>>) {
        return delegate.enqueue(object : Callback<S> {
            ...
            override fun onFailure(call: Call<S>, t: Throwable) {
                ...
                callback.onResponse(this@AANetworkResponseCall, Response.success(networkResponse))
            }
    ...
    override fun clone() = AANetworkResponseCall(delegate.clone(), errorConverter)
